            ...
            <div id="faqs" className="faqs">
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question4">
                  ...
                  get around this is to compress (zip) the folder and add files
                  as zip.
                </div>
              </div>
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question5">
                  Click <b>"Add File(s)"</b> button to select the file that you
                  want to share, or just drag and drop your file anywhere on
                  upload page to start sending.
                </div>
              </div>
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question8">
                  Your files will be stored on the server for a time frame of 7
                  days. For data privacy reasons, data that is subject to
                  expiration will be deleted automatically.
                  <br />
                  <br />
                  Once a file has expired, it is automatically removed from our
                  servers. Unfortunately once a file has been removed, there is
                  no way of retrieving it back.
                </div>
              </div>
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question9">
                  No, once the file is removed it's completely gone, no logs or
                  records are kept and the only way it can come back is if it's
                  uploaded again.
                </div>
              </div>
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question12">
                  Our service is accessible directly from your browser (Chrome,
                  Firefox, Internet Explorer, Safari...) without any software
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question17">
                  ...
                  The recipient can check their spam or junk folder. Sometimes,
                  email will end up in one of these folders.
                </div>
              </div>
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                <div
                  ...
                  href="#Question20"
                >
                  <i className="fa fa-question-circle" />I can't find downloaded
                  files. Where are they?
                </div>
                <div className="togglec collapse" id="Question20">
                  Your file will store in your computer's Downloads folder. This
                  can be changed (for Chrome, Explorer, Firefox, and Safari). If
                  you still do not find, use the search function on your
                  computer.{" "}
                </div>
              </div>
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question21">
                  Sendgb is bootstrapped and developed by a group of developers.
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question25">
                  We do not sell and do not distribute information of our users
                  to third parties. We only use your information to improve our
                  services.
                </div>
              </div>
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question26">
                  SendGB is totally free.No needed payment for sending files up
                  to 4 GB.
                </div>
              </div>
              ...
              <div className="toggle faq faq-marketplace faq-authors">
                ...
                <div className="togglec collapse" id="Question27">
                  SendGB is a totally free file transfer service. We always need
                  the support of our users. You can share SendGB with your
                  friends. You can also hear SendGB via social media. We can
                  support your social responsibility project with your
                  contribution.
                  <br />
                  <br />
